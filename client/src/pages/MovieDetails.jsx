  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      <div className='flex items-center flex-wrap gap-4 mt-4'>
        ...
        <button onClick={handleFavorite} className='bg-gray-700 p-2.5 rounded-full transition cursor-pointer active:scale-95'><Heart className={`w-5 h-5 ${favoriteMovies.some(movie => String(movie._id) === String(id)) ? 'fill-primary text-primary' : ""} `}/></button>
      </div>
      </div>
      </div>
